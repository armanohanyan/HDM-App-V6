...
Public Class RejectWarehouseWin

    Private iDuration As String = "00:00"

    Private Sub RejectWarehouseWin_Activated(sender As Object, e As EventArgs) Handles Me.Activated
    ...
    Private Sub Query()
        ...
        End Try
    End Sub
    Private Sub RejectWarehouseWin_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call Query()
    End Sub
