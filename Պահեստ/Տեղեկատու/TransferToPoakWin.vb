...
Public Class TransferToPoakWin

    Private Sub LoadPoak()
        ...
        Try
            ...
            Call CloseWindow("npoak")
            Dim f As New xotanpoakmarka With {.Text = "ՊՈԱԿ Պահեստ"}
            AddChildForm("npoak", f)
    ...
    Private Sub txtShtrikh_TextChanged(sender As Object, e As EventArgs) Handles txtShtrikh.TextChanged
        Try
            ...
            iDB.MoveToPoak(txtShtrikh.Text.Trim, txtComment.Text.Trim)
        ...
        End Try
    End Sub
    Private Sub TransferToPoakWin_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Call LoadPoak()
    End Sub
