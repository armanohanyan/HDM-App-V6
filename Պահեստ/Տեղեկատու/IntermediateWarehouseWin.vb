...
Public Class IntermediateWarehouseWin

    Private iDuration As String = "00:00"

    Private Sub IntermediateWarehouseWin_Activated(sender As Object, e As EventArgs) Handles Me.Activated
    ...
    Private Sub Query()
        ...
        Try
            ...
            dt = iDB.GetIntermediateWarehouseList
            eTime = Now
            ...
            With GridView1
                ...
                .Columns("Սարքավորում").SortOrder = DevExpress.Data.ColumnSortOrder.Ascending
            End With
        ...
        End Try
    End Sub
    Private Sub IntermediateWarehouseWin_Load(sender As Object, e As EventArgs) Handles Me.Load
        'Call Query()
    End Sub
