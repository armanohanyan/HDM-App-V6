Public Class AcountWarhExSel
    ...
    Private Sub btnShow_Click(sender As Object, e As EventArgs) Handles btnShow.Click
        ...
        'Dim f As New AccRepWarehouseExisting With {.sDate = sDate.DateTime, .eDate = eDate.DateTime, .WarehouseID = cbSupporter.SelectedValue, .EquipmentID = cEquipment.SelectedValue, .IsEquipment = cNoNyut.Checked}
