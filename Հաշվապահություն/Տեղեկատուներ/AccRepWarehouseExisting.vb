...
Public Class AccRepWarehouseExisting
    ...
    '            dt = iDB.RepMnacordWarAllEquipAll2(sDate, eDate, IsEquipment)
    '        ElseIf WarehouseID = 0 AndAlso EquipmentID > 0 Then
    '            dt = iDB.RepMnacordWarAllEquipUniq2(sDate, eDate, EquipmentID)
    '        ElseIf WarehouseID > 0 AndAlso EquipmentID = 0 Then
    '            dt = iDB.RepMnacordWarUniqueEquipAll2(sDate, eDate, WarehouseID, IsEquipment)
    '        ElseIf WarehouseID > 0 AndAlso EquipmentID > 0 Then
    '            dt = iDB.RepMnacordWarUniqueEquipUnique2(sDate, eDate, WarehouseID, EquipmentID)
    '        End If
