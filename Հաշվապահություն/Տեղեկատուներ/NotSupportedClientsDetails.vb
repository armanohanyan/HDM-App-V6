...
Public Class NotSupportedClientsDetails
    ...
    Private Sub GridControl1_KeyDown(sender As Object, e As KeyEventArgs) Handles GridControl1.KeyDown
        ...
        End If
    End Sub
    Private Sub NotSupportedClientsDetails_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        LoadData()
    End Sub
