...
Public Class MakeInnerInvoiceXML

    Friend SupporterID As Byte
    Friend StartDate As DateTime
    Friend EndDate As DateTime

    Private Sub LoadData()
        Try
            Dim DT As DataTable = iDB.InvInnerInvoices(SupporterID, StartDate, EndDate)
    ...
    Private Sub createXMLFiles2(dirName As String, rID As Integer, dealDate As Date)
        Try
            ...
            Dim dt As System.Data.DataTable = iDB.GetInnerInvDetailsNoNDS(rID)
            If dt.Rows.Count = 0 Then Throw New Exception("Տվյալներ չկան")
