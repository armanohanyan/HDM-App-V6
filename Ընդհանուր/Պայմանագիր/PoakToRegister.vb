...
Public Class PoakToRegister
    ...
    Private Sub LoadData()
        ...
        End Try
    End Sub
    Private Sub PoakToRegister_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        MainWindow.InfoTime.Caption = iDuration
    End Sub
    Private Sub PoakToRegister_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call LoadData()
    End Sub
