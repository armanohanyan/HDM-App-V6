...
Public Class WorkingClientsDisolved

    Dim iDuration As String = "0:0"
    ...
    Private Sub LoadData()
        ...
        End Try
    End Sub
    Private Sub WorkingClientsDisolved_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Call LoadData()
    End Sub
