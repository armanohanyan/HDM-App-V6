...
#Region "Records"
    ...
    Friend Sub UpdateRecords()
        ...
        Dim strVal As String = GridView1.GetFocusedDataRow.Item("Բանկ").ToString

        Dim f As New UpdateBank With {.iBank = strVal, .iBankID = ID}
        With f
            .ShowDialog()
            .Dispose()
        End With
