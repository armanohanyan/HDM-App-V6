...
Public Class hdmAraqumSentWindow
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            If iUser.DB = 5 Then
                dt = iDB.GetAllEcrShipping
            Else
                dt = iDB.GetAllEcrShipping2(iUser.DB)
            End If
            ...
            With GridView1
                ...
                .Columns("ՓակմանԱմսաթիվ").DisplayFormat.FormatString = "HH:mm:ss dd.MM.yyyy"
                .BestFitColumns(True)
            End With
        ...
        End Try
    End Sub
    Private Sub hdmAraqumSentWindow_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        MainWindow.InfoTime.Caption = iDuration
    End Sub
    ...
    Private Sub hdmAraqumSentWindow_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call LoadData()
    End Sub
