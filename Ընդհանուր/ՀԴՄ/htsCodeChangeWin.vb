...
Public Class htsCodeChangeWin
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            sTime = Now
            dt = iDB.HTSChangeByClient(iClientID)
            eTime = Now
        ...
        End Try
    End Sub
    Private Sub htsCodeChangeWin_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        MainWindow.InfoTime.Caption = iDuration
    End Sub
    Private Sub htsCodeChangeWin_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call LoadData()
    End Sub
