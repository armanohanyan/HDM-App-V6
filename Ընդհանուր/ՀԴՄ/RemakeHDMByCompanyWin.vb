...
Public Class RemakeHDMByCompanyWin

    Private iDuration As String = "00:00"
    Friend iClientID As Integer = 0

    Friend FromCallCenter As Boolean = False
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            sTime = Now
            dt = iDB.GetRemakeHDMByCompany(iClientID)
            eTime = Now
    ...
    Private Sub LoadData2()
        ...
        Try
            ...
            sTime = Now
            dt = iDB.CallCenterRemakeInfo(iClientID)
            eTime = Now
        ...
        End Try
    End Sub
    Private Sub RemakeHDMByCompanyWin_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        MainWindow.InfoTime.Caption = iDuration
    End Sub
    Private Sub RemakeHDMByCompanyWin_Load(sender As Object, e As EventArgs) Handles Me.Load
        If FromCallCenter = True Then
            Call LoadData2()
        Else
            Call LoadData()
        End If
