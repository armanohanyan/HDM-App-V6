...
#Region "Records"
    ...
    Friend Sub AddRecord()
        Dim f As New TesuchInfoAddWindow
        With f
            .ShowDialog()
            .Dispose()
        End With
    ...
    Friend Sub DeleteRecord()
        ...
        If q = MsgBoxResult.Yes Then
            iDB.DeleteTesuchRegionInfo(recID)
...
#End Region
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            sTime = Now
            dt = iDB.GetTesuchRegionInfoList
            eTime = Now
        ...
        End Try
    End Sub
    Private Sub TesuchInfoWindow_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        MainWindow.InfoTime.Caption = iDuration
    End Sub
    Private Sub TesuchInfoWindow_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call LoadData()
    End Sub
