...
#Region "Records"
    ...
    Friend Sub UpdateRecords()
        ...
        Dim strRegion As String = GridView1.GetFocusedDataRow.Item("Տարածաշրջան").ToString

        Dim f As New RegionUpdateWindow With {.iRegion = strRegion, .iRegionID = recID}
        With f
            .ShowDialog()
            .Dispose()
        End With
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            If GridView1.RowCount > 0 Then
                If GridView1.Columns("Տարածաշրջան").Summary.ActiveCount = 0 Then
                    Dim item As GridColumnSummaryItem = New GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "Տարածաշրջան", "Քանակ {0}")
                    GridView1.Columns("Տարածաշրջան").Summary.Add(item)
                End If
            End If
        ...
        End Try
    End Sub
    Private Sub RegionWindow_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        MainWindow.InfoTime.Caption = iDuration
    End Sub
    Private Sub RegionWindow_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call LoadData()
    End Sub
