...
#Region "Records"
    ...
    Friend Sub UpdateRecords()
        ...
        Dim strContract As String = GridView1.GetFocusedDataRow.Item("Պայմանագիր").ToString

        Dim f As New ContractUpdateWindow With {.iContractID = ID, .iContract = strContract}
        With f
            .ShowDialog()
            .Dispose()
        End With
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            If GridView1.RowCount > 0 Then
                If GridView1.Columns("Պայմանագիր").Summary.ActiveCount = 0 Then
                    Dim item As GridColumnSummaryItem = New GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "Պայմանագիր", "Քանակ {0}")
                    GridView1.Columns("Պայմանագիր").Summary.Add(item)
                End If
            End If
        ...
        End Try
    End Sub
    Private Sub ContractWindow_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        MainWindow.InfoTime.Caption = iDuration
    End Sub
    Private Sub ContractWindow_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call LoadData()
    End Sub
