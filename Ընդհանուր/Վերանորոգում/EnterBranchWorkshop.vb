...
Public Class EnterBranchWorkshop
    ...
    Private Sub txtEcr_TextChanged(sender As Object, e As EventArgs) Handles txtEcr.TextChanged
        ...
        End Try
    End Sub
    Private Sub EnterBranchWorkshop_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        If CheckPermission2("79D616F151A04E5BA84D9FE052D6C2FB") = False Then txtEcr.Enabled = False
    End Sub
