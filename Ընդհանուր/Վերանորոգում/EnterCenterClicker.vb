...
Public Class EnterCenterClicker
    ...
    Private Sub txtEcr_TextChanged(sender As Object, e As EventArgs) Handles txtEcr.TextChanged
        ...
        End Try
    End Sub
    Private Sub EnterCenterClicker_Load(sender As Object, e As EventArgs) Handles Me.Load
        If (iUser.DB = 1 OrElse iUser.DB = 3) Then txtEcr.Enabled = False
    End Sub
    Private Sub EnterCenterClicker_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        If CheckPermission2("D7BBDA4BA12F4D118BA80119401E2F7D") = False Then txtEcr.Enabled = False
    End Sub
