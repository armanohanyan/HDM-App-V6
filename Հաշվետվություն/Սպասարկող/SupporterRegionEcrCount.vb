...
Public Class SupporterRegionEcrCount

    Private iDuration As String = "00:00"

    Friend supporterID As Byte = 0
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            If supporterID <> 0 Then
                dt = iDB.GetSupporterRegionEcrCountBySupp(supporterID)
            Else
                dt = iDB.QueryToSqlServer2("SELECT * FROM Supporter.GetSupporterRegionEcrCount()", CommandType.Text)
            End If
            eTime = Now
        ...
        End Try
    End Sub
    Private Sub SupporterRegionEcrCount_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        MainWindow.InfoTime.Caption = iDuration
    End Sub
    Private Sub SupporterRegionEcrCount_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call LoadData()
    End Sub
