...
Public Class RepEcrLocation

    Private iDuration As String = "00:00"

    Friend supporterID As Byte

    Friend OnlyOpen As Boolean = False
    ...
    Private Sub mnuExportToExcel_Click(sender As Object, e As EventArgs) Handles mnuExportToExcel.Click
        ...
        End Try
    End Sub
    Private Sub RepEcrLocation_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If supporterID = 0 Then
                dt = iDB.GetRemakeEcrLocationReport(Not OnlyOpen)
            Else
                dt = iDB.GetRemakeEcrLocationReportBySupporter(supporterID, Not OnlyOpen)
            End If
            ...
            With GridView1
                ...
                .Columns("ԵլքՄասնաճյուղից").SortOrder = DevExpress.Data.ColumnSortOrder.Ascending
