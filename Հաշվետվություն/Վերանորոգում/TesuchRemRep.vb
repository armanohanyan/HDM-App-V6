...
Public Class TesuchRemRep
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            dt = iDB.GetTesuchRemakeDetailsRep(sDate, eDate)
    ...
    Private Sub TesuchRemRep_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        MainWindow.InfoTime.Caption = iDuration
    End Sub
    Private Sub TesuchRemRep_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Call LoadData()
    End Sub
