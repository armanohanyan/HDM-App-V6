...
Public Class repNotApprovedGPRS
    ...
    Private Sub mnuExportToExcel_Click(sender As Object, e As EventArgs) Handles mnuExportToExcel.Click
        ...
        End Try
    End Sub
    Private Sub repNotApprovedGPRS_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            With GridView1
                ...
                .Columns("Սերիալ").BestFit()
                .Columns("Ամսաթիվ").BestFit()
            End With
            If GridView1.RowCount > 0 Then
                If GridView1.Columns("Սերիալ").Summary.ActiveCount = 0 Then
                    Dim item As GridColumnSummaryItem = New GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "Սերիալ", "{0}")
                    GridView1.Columns("Սերիալ").Summary.Add(item)
                End If
            End If
        Catch ex As ExceptionClass
