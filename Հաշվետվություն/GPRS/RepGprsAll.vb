...
Public Class RepGprsAll
    ...
    Private Sub mnuExportToExcel_Click(sender As Object, e As EventArgs) Handles mnuExportToExcel.Click
        ...
        End Try
    End Sub
    Private Sub RepGprsAll_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            With GridView1
                ...
                .Columns("ՍտացմանԱմսաթիվ").SortOrder = DevExpress.Data.ColumnSortOrder.Descending
            End With
