...
Public Class RepGprsChanges
    ...
    Private Sub mnuExportToExcel_Click(sender As Object, e As EventArgs) Handles mnuExportToExcel.Click
        ...
        End Try
    End Sub
    Private Sub RepGprsChanges_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If GridView1.RowCount > 0 Then
                If GridView1.Columns("Օգտվող").Summary.ActiveCount = 0 Then
                    Dim item As GridColumnSummaryItem = New GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "Օգտվող", "Քանակ {0}")
                    GridView1.Columns("Օգտվող").Summary.Add(item)
                End If
            End If
        Catch ex As ExceptionClass
