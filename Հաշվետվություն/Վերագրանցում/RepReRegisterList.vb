...
Public Class RepReRegisterList
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            With GridView1
                ...
                .Columns("ՎերագրանցմանԱմսաթիվ").SortOrder = DevExpress.Data.ColumnSortOrder.Descending
                .BestFitColumns(True)
            End With
        ...
        End Try
    End Sub
    Private Sub RepReRegisterList_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        MainWindow.InfoTime.Caption = iDuration
    End Sub
    Private Sub mnuExportToExcel_Click(sender As Object, e As EventArgs) Handles mnuExportToExcel.Click
        ...
        End Try
    End Sub
    Private Sub RepReRegisterList_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call LoadData()
    End Sub
