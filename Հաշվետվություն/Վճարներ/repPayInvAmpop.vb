...
Public Class repPayInvAmpop
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            If SupporterID = 0 Then
                dt = iDB.RepPayInvoiceTotalStats()
            Else
                dt = iDB.RepPayInvoiceTotalStatsBySupporter(SupporterID)
            End If
    ...
    Private Sub mnuExportToExcel_Click(sender As Object, e As EventArgs) Handles mnuExportToExcel.Click
        ...
        End Try
    End Sub
    Private Sub repPayInvAmpop_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Call LoadData()
    End Sub
