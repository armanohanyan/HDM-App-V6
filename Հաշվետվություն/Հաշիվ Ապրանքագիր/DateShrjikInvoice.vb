...
Public Class DateShrjikInvoice
    ...
    Private Sub btnQuery_Click(sender As Object, e As EventArgs) Handles btnQuery.Click
        ...
        Try
            ...
            f.Text = "Շրջիկ Հաշիվ Ապրանքագիր"

            Dim sID As Byte = cSupporter.SelectedValue

            dt = iDB.GetShrjikInvoice(sID, cYear.SelectedItem, cMonth.SelectedItem)
        ...
        End Try
    End Sub
    Private Sub DateShrjikInvoice_Load(sender As Object, e As EventArgs) Handles Me.Load
        cYear.Items.Clear()
