...
Public Class DateRemakeInvoice
    ...
    Private Sub btnQuery_Click(sender As Object, e As EventArgs) Handles btnQuery.Click
        ...
        Try
            ...
            Call CloseWindow("nRemakeInvoice")
            Dim f As New RepNotRetInvoice
            f.Text = "Վերանորոգման Հաշիվ Ապրանքագիր"

            Dim sID As Byte = cSupporter.SelectedValue

            dt = iDB.GetRemakeInvoice(sID, cYear.SelectedItem, cMonth.SelectedItem)

            AddChildForm("nRemakeInvoice", f)
        ...
        End Try
    End Sub
    Private Sub DateRemakeInvoice_Load(sender As Object, e As EventArgs) Handles Me.Load
        cYear.Items.Clear()
