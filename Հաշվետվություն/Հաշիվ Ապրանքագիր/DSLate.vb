...
Public Class DSLate
    ...
    Private Sub btnQuery_Click(sender As Object, e As EventArgs) Handles btnQuery.Click
        ...
        Try
            ...
            dt = iDB.LateInvoice(cYear.SelectedItem, cMonth.SelectedItem, cSupporter.SelectedValue)

            Call CloseWindow("nLateInvoiceWindow")
            Dim f As New LateInvoiceWindow
            AddChildForm("nLateInvoiceWindow", f)
            ...
            If f.GridView1.RowCount > 0 Then
                ...
                End If
                If f.GridView1.Columns("ԱմբողջԳումարը").Summary.ActiveCount = 0 Then
                    Dim item As GridColumnSummaryItem = New GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "ԱմբողջԳումարը", "{0:n2}")
                    f.GridView1.Columns("ԱմբողջԳումարը").Summary.Add(item)
                End If
            End If
        ...
        End Try
    End Sub
    Private Sub DSLate_Load(sender As Object, e As EventArgs) Handles Me.Load
        cYear.Items.Clear()
