...
Public Class CallSmsGeneral
    ...
    Private Sub SendSMSToTEsuch()
        Try
            ...
            'Save to DB
            iDB.InsertSMSToTesuchGeneral(I_Tesuch, txtMessage.Text.Trim, I_Tel, I_PropID)
